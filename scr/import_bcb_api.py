...
Original file is located at
    https://colab.research.google.com/drive/1K7uqsH6-yUTJ6YV-FAUx-Kp06hB1IzRV
...
# Compute the sum of last 12 months for each row
#df_macro['eco_inflation_month_12months'] = df_macro['eco_inflation_month'].rolling(window=12).apply(lambda x: (1 + x/100).prod() - 1).dropna() * 100

# Adjust index date format
df_macro = adjust_index_date_format(df_macro)

df_macro.to_csv('../data/df_macroeco.csv', index=True)