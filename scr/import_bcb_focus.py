...
Original file is located at
    https://colab.research.google.com/drive/1eU779cR5ieXzafzjQAw_apijwpQh6PrQ
...
#df_BR_indicators.set_index('Data', inplace=True).rename_axis('date', inplace=True)
...
df_focus_indicators_monthly = useful_functions.convert_df_to_monthly(df_BR_indicators_wide,'%Y-%m-%d')
